...
export function Competences() {
  ...
  const skills = [
    ...
    { name: "PHP", cat: "Back-end", tag: "langage" },
    { name: "JAVA", cat: "Back-end", tag: "langage" },
    { name: "Spring Boot", cat: "Back-end", tag: "framework" },
    { name: "React / Next.js", cat: "Front-end", tag: "framework" },
    { name: "React Native", cat: "Front-end", tag: "mobile" },
    { name: "JavaScript", cat: "Front-end", tag: "langage" },
    { name: "MySQL", cat: "Back-end", tag: "BDD"},
    { name: "PostgreSQL", cat: "Back-end", tag: "BDD"},
    { name: "Linux", cat: "Back-end", tag: "système" },
    { name: "Docker", cat: "Outils", tag: "Conteneur" },
    ...
    { name: "Git", cat: "Outils", tag: "versioning" },
  ];
